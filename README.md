...
the most sophisticated algorithms of artificial intelligence, an example is the neural style transfer (NST) algorithms  based on convolutional neural networks (CNNs). 
