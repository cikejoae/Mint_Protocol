...
import {Link, Grid, HStack, VStack,Flex, Box, Spacer, Breadcrumb, BreadcrumbItem,  
         Heading, Text, Button, Divider, Stack, Center, Image, useColorModeValue, Container } from '@chakra-ui/react'
  ...
  return (
    <Grid w='100%' h='100%'>
      ...
      <Heading h='200px' w='900px'
              ...
              <Button  as={ReachLink} to='/mint' colorScheme='pink' size='md' height='60px'
                      width='200px'
                      borderRadius='30px'
                      >
